...
export const DEFAULT_META: PageMeta = {
  title: 'DAO Swap',
  description:
    'The most popular AMM on BSC by user count! then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings and more, on a platform you can trust.',
}
